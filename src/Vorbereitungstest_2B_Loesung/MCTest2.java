package Vorbereitungstest_2B_Loesung;// Bitte beantworten Sie die Multiple-Choice-Fragen (maximal 25 Punkte, 1 Punkt pro 'Choice').
    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(true, "Iteratoren über Bäumen traversieren Bäume meist rekursiv.                          (1A)"),
                        new Choice(true, "Das Interface Iterator spezifiziert die Methoden next() und hasNext().             (1B)"),
                        // Question unclear; how would easier be defined specifically? Less code?
                        new Choice(false, "Binärbäume sind meist einfacher iterierbar als lineare Listen.                     (1C)"),
                        new Choice(true, "Iterator-Implementierungen bestimmen die Reihenfolge der Iterationen.              (1D)"),
                        // False, different iterators can provide different views
                ...
                new Question(
                        ...
                        // An invariant is a condition that is true before and after each iteration of the loop.

                        // k is initiated to 1 before the loop stars
                        new Choice(false, "k > 1                                                                              (2A)"),
                        new Choice(true, "g == 5                                                                             (2B)"),
                        // after the last iteration, k = g
                        new Choice(false, "k > 0 && k < g                                                                     (2C)"),
                        new Choice(true, "k >= 1 && k <= g                                                                   (2D)"),
                        // w = (k + 1) + (k + 2) + ...
                ...
                new Question(
                        ...
                        new Choice(true, "Nachbedingung: Ergebnis hängt von einem Eintrag von i ab.                          (3C)"),
                        new Choice(true, "Nachbedingung: Gibt den Median zurück wenn i sortiert ist.                         (3D)"),
                ...
                new Question(
                        ...
                        new Choice(true, "Reguläre Ausdrücke können Prüfungen von Datenformaten vereinfachen.                (4A)"),
                        new Choice(true, "Reparaturversuche nicht plausibler Daten können gefährlich sein.                   (4B)"),
                        ...
                        new Choice(true, "Wir müssen die Korrektheit prüfen, nicht nur die Plausibilität.                    (4E)")
                ),

                new Question(
                        "Welche der folgenden Aussagen treffen auf Schleifen und Schleifeninvarianten zu?",

                        // the loop condition will be false after the last iteration, otherwise the loop would not terminate
                        new Choice(true, "Die Abbruchbedingung kann nicht Teil einer Schleifeninvariante sein.               (5A)"),
                        // before and after each loop iteration
                        new Choice(false, "Schleifeninvarianten müssen nur im Schleifenrumpf gelten.                          (5B)"),
                        new Choice(true, "Schleifeninvarianten helfen dabei, Programme statisch zu verstehen.                (5C)"),
                        new Choice(false, "Durch Schleifeninvarianten sind Schleifen im Debugger iterierbar.                  (5D)"),
                        new Choice(true, "Fortschritt muss unabhängig von Schleifeninvarianten geprüft werden.               (5E)")
                )
        );
    }
