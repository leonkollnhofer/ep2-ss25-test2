...
public class ApplicationTest2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            testEquals(mobile3.hashCode() == mobile5.hashCode(), true);
            ...
            System.out.println("\nTest 6: 'replace' and 'getStickSetView'");
            StickSet stickSet = mobile1.getStickSetView();
            testEquals(stickSet.size(), 3);
            testEquals(stickSet.contains((Stick)mobile1), true); // contains itself
            testEquals(stickSet.contains(m3), true);
            m2.replace(m3, new Star(7));
            testEquals(stickSet.size(), 2);
            testEquals(stickSet.contains(m3), false);
